    ...
    public function runJob(): void
    {
        ...
        if (get_option('gjwa_pro_product_synchronize_price', 0) == 0) {
            ...
            foreach ($wooCommerceProfileIds as $profileId) {
	            ...
	            $filters = [
		            'WHERE' => sprintf('auction_profile_id = %d AND auction_update_woocommerce_price = 1', $profileId)
	            ];
	            ...
	            $auctions = array_filter($auctions, function($auction) use ($auctionsModel) {
		            return $auctionsModel->getWoocommerceId($auction['auction_id']) != 0;
	            });
