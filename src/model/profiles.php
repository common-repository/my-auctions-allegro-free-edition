...
class GJMAA_Model_Profiles extends GJMAA_Model
{
	...
	public function update($currentVersion)
	{
		...
		if(version_compare($currentVersion, '3.6.17') < 0) {
			$this->addProfileAffiliateProducts();
		}
	...
	public function addProfileAffiliateProducts()
	{
		$this->addColumn($this->getTable(), 'profile_affiliate_products', [
			'INT (2)',
			'NOT NULL',
			'DEFAULT 0'
		]);
